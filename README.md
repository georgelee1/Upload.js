...
|Name|Option|Description|Values|
:--- | :--- | :--- | :---
|<a href="#option-upload-url" name="option-upload-url"></a>Upload Url|<div>`upload: { url: <string> }`<div>or<div>`data-upload-url="<string>"`<div>|The URL that is called when uploading a file. The url must return `JSON` with `success: true` if the upload was successful and with `uploadImageId: <id>` where `<id>` is a unique identifier for the file that will then get called to the deletion URL. If `uploadImageId` is not returned the uploaded file will not be deletable from the widget.|`<string>`|
|<a href="#option-upload-parameter" name="option-upload-parameter"></a>Upload Parameter|<div>`upload: { param: <string> }`<div>or<div>`data-upload-param="<string>"`<div>|The name of the parameter that each file is set as in the upload request.|`<string>`<br/>*Default:*`'file'`|
|<a href="#option-deletion-url" name="option-deletion-url"></a>Deletion Url|<div>`delete: { url: <string> }`<div>or<div>`data-delete-url="<string>"`<div>|The URL that is called when deleting a file. The url must return `JSON` with `success: true` if the deletion was successful.||
|<a href="#option-deletion-parameter" name="option-deletion-parameter"></a>Deletion Parameter|<div>`delete: { param: <string> }`<div>or<div>`data-delete-param="<string>"`<div>|The name of the parameter set with the file id that is set on the deletion request.|`<string>`<br/>*Default:*`'file'`|
|<a href="#option-max" name="option-max"></a>Max|<div>`max: <int>`</div>**or**<div>`data-upload-max="<int>"`</div>|The maximum number of files that are allowed to exist in the widget.|`<int>`<br/>*Default:*`infinite`|
|<a href="#option-deletable" name="option-deletable"></a>Deletable|<div>`deletable: <boolean>`</div>**or**<div>`data-upload-deletable="<boolean>"`</div>|Indicates whether or not files are deletable. If `true` the delete button will appear for each file, when clicked the [deletion url](#option-deletion-url) is called.|`<boolean>`<br/>*Default*:`true`|
|<a href="#option-allowed-types" name="option-allowed-types"></a>Allowed Types|<div>`allowed_types: []`</div>**or**<div>`data-upload-allowed-types="<string>[,<string>[,...]]"`</div>|`<array>` or commor (`,`) separated `<string>` of allowed file MIME content types e.g. `image/png`, `image/jpg`. You can use the predefined type key `images` which includes `["image/jpg", "image/jpeg", "image/png", "image/gif"]` e.g. `allowed_types: ["images"]`.|`<array>` or `<string>`<br/>*Default:*`["images"]`|
